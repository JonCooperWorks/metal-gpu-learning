...
|--------|--------|-------------------|
| 1 | [01-hello-gpu/](01-hello-gpu/) | Device discovery -- connect to the GPU, query its properties |
| 2 | [02-double-values/](02-double-values/) | Your first compute kernel -- the full Metal pipeline end-to-end |
| 3 | [03-vector-add/](03-vector-add/) | Multiple input buffers -- element-wise vector addition |
| 4 | [04-parallel-sum/](04-parallel-sum/) | Atomic operations -- parallel reduction to sum an array |
| 5 | [05-double-buffering/](05-double-buffering/) | Overlap CPU fill and GPU compute with two alternating buffer slots |
| 6 | [06-market-tick-aggregation/](06-market-tick-aggregation/) | Real analytics pipeline -- transform market ticks and reduce to VWAP/volatility/min/max |
| 7 | [07-credit-card-fraud-detector/](07-credit-card-fraud-detector/) | Fraud rules engine -- score transactions and reduce TP/FP/TN/FN + precision/recall/FPR metrics |
| 8 | [08-basic-llm/](08-basic-llm/) | Basic LLM inference -- single-head attention + tiny autoregressive generation loop |
